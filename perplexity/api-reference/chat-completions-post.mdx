              ...
              language_preference:
                allOf:
                  - title: Language Preference
                    type: string
                    description: >-
                      **Perplexity-Specific**: The language preference for the
                      chat completion response content. Controls the language
                      (i.e., English, Korean, Spanish, etc.) of the response
                      content.
