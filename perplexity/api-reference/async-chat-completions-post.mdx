    ...
    ChatCompletionsRequest:
      ...
      properties:
        ...
        language_preference:
          ...
          type: string
          description: >-
            **Perplexity-Specific**: The language preference for the chat
            completion response content. Controls the language (i.e., English,
            Korean, Spanish, etc.) of the response content.
        search_domain_filter:
