...
<Callout kind="info">
  The stable python versions to use with CrewAI are **Python >=3.10 and Python <3.13**.
</Callout>
...
You can customize the search tool by passing parameters to configure its behavior:
...
<Callout kind="tip">
  For a complete list of available parameters and their descriptions, visit our [API documentation](/tavily/api-reference/introduction) to discover all the customization options available for search operations.
</Callout>

<Expandable title="Full Code Example - Search" default-open="false">
```python
import os
from crewai import Agent, Task, Crew
from crewai_tools import TavilySearchTool
...
You can customize the extract tool by passing parameters to configure its behavior:
...
<Callout kind="tip">
  For a complete list of available parameters and their descriptions, visit our [API documentation](/tavily/api-reference/introduction) to discover all the customization options available for extract operations.
</Callout>

<Expandable title="Full Code Example - Extract" default-open="false">
```python
import os
from crewai import Agent, Task, Crew
from crewai_tools import TavilyExtractorTool
