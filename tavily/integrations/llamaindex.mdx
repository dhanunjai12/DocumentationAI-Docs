---
title: LlamaIndex
description: Search the web from LlamaIndex with Tavily using the TavilyToolSpec integration.
---
...
You can access Tavily in LlamaIndex through the `TavilyToolSpec`.
