---
title: Dify
description: Integrate Tavily with Dify to enhance your AI workflows without writing any code.
---
...
<ExpandableGroup>
  <Expandable title="Step 1: Log in to Dify" default-open="false">
    Go to [Dify](https://dify.ai/) and log in to your account.
  </Expandable>

  <Expandable title="Step 2: Obtain Your Tavily API Key" default-open="false">
    Go to the [Tavily Dashboard](https://app.tavily.com/home) to obtain your **API key**.
  </Expandable>

  <Expandable title="Step 3: Install the Tavily Tool" default-open="false">
  ...
  <Expandable title="Step 4: Authorize Tavily in Dify" default-open="false">
...
<Image 
  src="https://mintcdn.com/tavilyai/tgJqPSjqNVSkMFTO/images/defy-tavily.png?fit=max&auto=format&n=tgJqPSjqNVSkMFTO&q=85&s=661597a8a309ab38870e3600fa07fbc5"
  alt="Dify Tavily Integration" 
  width="1256"
  height="1076"
/>
