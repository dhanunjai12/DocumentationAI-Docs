---
title: Make
description: Integrate Tavily with Make to enhance your business processes without writing a single line of code.
---

<Image 
  src="https://mintcdn.com/tavilyai/tgJqPSjqNVSkMFTO/images/make-tavily.gif?s=8c21f3b24b94f8648447746c67f92be6"
  alt="Make Tavily Integration" 
  width="1060"
  height="720"
/>
...
<ExpandableGroup>
  <Expandable title="Step 1: Log in to Make" default-open="false">
    [Log in](https://www.make.com/en/login) to your Make account.
  </Expandable>

  <Expandable title="Step 2: Create a New Scenario" default-open="false">
    Create a new scenario and select a trigger module that will start your workflow.
  </Expandable>

  <Expandable title="Step 3: Add Tavily as an Action Module" default-open="false">
